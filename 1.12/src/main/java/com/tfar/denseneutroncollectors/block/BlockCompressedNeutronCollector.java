...
public class BlockCompressedNeutronCollector extends BlockContainer implements IModelRegister {

    public BlockCompressedNeutronCollector() {
        super(Material.IRON);
        setSoundType(SoundType.METAL);
        setHardness(20);
        setUnlocalizedName("denseneutroncollectors:compressed_neutron_collector");
        setHarvestLevel("pickaxe", 3);
        setCreativeTab(Avaritia.tab);
        setRegistryName("compressed_neutron_collector");
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
        if (world.isRemote) {
            ...
            player.openGui(DenseNeutronCollectors.instance, 0, world, pos.getX(), pos.getY(), pos.getZ());
            return true;
        }
    }
    ...
    public TileEntity createNewTileEntity(World world, int meta) {
        return new TileCompressedNeutronCollector();
    }

    @Override
    public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase player, ItemStack stack) {
        TileEntity tile = world.getTileEntity(pos);
        if (tile instanceof TileCompressedNeutronCollector) {
            TileCompressedNeutronCollector machine = (TileCompressedNeutronCollector) tile;
    ...
    public void breakBlock(World world, BlockPos pos, IBlockState state) {
        TileCompressedNeutronCollector collector = (TileCompressedNeutronCollector) world.getTileEntity(pos);
    ...
    public void registerModels() {
        ...
        ModelLoader.setCustomStateMapper(this, new StateMapperBase() {
            ...
            protected ModelResourceLocation getModelResourceLocation(IBlockState state) {
                String modelLoc = "type=compressed_neutron_collector";
        ...
        ModelResourceLocation invLoc = new ModelResourceLocation(location, "type=compressed_neutron_collector,facing=north,active=true");
