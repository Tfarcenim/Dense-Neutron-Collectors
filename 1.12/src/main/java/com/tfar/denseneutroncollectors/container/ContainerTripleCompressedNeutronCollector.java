...
public class ContainerTripleCompressedNeutronCollector extends ContainerMachineBase<TileTripleCompressedNeutronCollector> {
    public ContainerTripleCompressedNeutronCollector(InventoryPlayer playerInventory, TileTripleCompressedNeutronCollector machine) {
        super(machine);
