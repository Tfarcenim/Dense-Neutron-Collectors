...
public class ContainerCompressedNeutronCollector extends ContainerMachineBase<TileCompressedNeutronCollector> {
    public ContainerCompressedNeutronCollector(InventoryPlayer playerInventory, TileCompressedNeutronCollector machine) {
        super(machine);
