...
public class TileCompressedNeutronCollector extends TileMachineBase implements IInventory {
    ...
    public void doWork() {
        if (++progress >= ticks) {
            if (neutrons.isEmpty()) {
                neutrons = ItemUtils.copyStack(ModItems.neutron_nugget, 1);
            } else if (ItemUtils.areStacksSameType(neutrons, ModItems.neutron_nugget)) {
    ...
    public String getName() {
        return "container.compressed_neutron";
    }
